...
public class HIPIEAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected HIPIESwitch<Adapter> modelSwitch =
    new HIPIESwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casepos_viz_data(pos_viz_data object)
      {
        return createpos_viz_dataAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseout_dataset(out_dataset object)
      {
        return createout_datasetAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.hipie.hIPIE.pos_viz_data <em>pos viz data</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createpos_viz_dataAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.hipie.hIPIE.out_dataset <em>out dataset</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createout_datasetAdapter()
  {
    return null;
  }
