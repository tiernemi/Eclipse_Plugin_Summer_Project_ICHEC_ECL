...
public class HIPIESwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case HIPIEPackage.FIELD_DECL:
      {
        ...
        if (result == null) result = casepos_viz_data(field_decl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case HIPIEPackage.ECL_INTEGER:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_integer);
      ...
      case HIPIEPackage.ECL_UNSIGNED:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_unsigned);
      ...
      case HIPIEPackage.ECL_STRING:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_string);
      ...
      case HIPIEPackage.ECL_QSTRING:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_qstring);
      ...
      case HIPIEPackage.ECL_VARSTRING:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_varstring);
      ...
      case HIPIEPackage.ECL_UNICODE:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_unicode);
      ...
      case HIPIEPackage.ECL_VARUNICODE:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_varunicode);
      ...
      case HIPIEPackage.ECL_DATA:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_data);
      ...
      case HIPIEPackage.ECL_REAL:
      {
        ...
        if (result == null) result = casepos_viz_data(ecl_real);
      ...
      case HIPIEPackage.ECLFIELD_TYPE:
      {
        ...
        if (result == null) result = casepos_viz_data(eclfield_type);
      ...
      {
        pos_viz_data pos_viz_data = (pos_viz_data)theEObject;
        T result = casepos_viz_data(pos_viz_data);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case HIPIEPackage.OUTPUT_OPTION:
      {
        ...
        if (result == null) result = caseOutputOptions(outputOption);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        out_dataset out_dataset = (out_dataset)theEObject;
        T result = caseout_dataset(out_dataset);
        if (result == null) result = caseoutput_value(out_dataset);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T casepos_viz_data(pos_viz_data object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseout_dataset(out_dataset object)
  {
    return null;
  }
