...
public interface HIPIEPackage extends EPackage
{
   ...
   * @ordered
   */
  int OUT_TYPE__OPS = OUTPUT_VALUE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int OUT_TYPE_FEATURE_COUNT = OUTPUT_VALUE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int VALUE__NAME = OUT_TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int VALUE__INT_VAL = OUT_TYPE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int VALUE__STR_VAL = OUT_TYPE_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int VALUE__RES_OPS = OUT_TYPE_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int VALUE_FEATURE_COUNT = OUT_TYPE_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int ASSIGN__NAME = ASSIGN_LIST_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int ASSIGN__VALS = ASSIGN_LIST_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ASSIGN__ASSIGN_INTERNAL = ASSIGN_LIST_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int ASSIGN_FEATURE_COUNT = ASSIGN_LIST_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link org.xtext.hipie.hIPIE.impl.pos_viz_dataImpl <em>pos viz data</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.xtext.hipie.hIPIE.impl.pos_viz_dataImpl
   * @see org.xtext.hipie.hIPIE.impl.HIPIEPackageImpl#getpos_viz_data()
   * @generated
   */
  int POS_VIZ_DATA = 34;
   ...
   * @ordered
   */
  int FIELD_DECL__INPUT_INTERNAL = POS_VIZ_DATA_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int DATASET__INPUT_OPS = DATATYPE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ECLFIELD_TYPE__NAME = POS_VIZ_DATA__NAME;
   ...
   * @ordered
   */
  int ECLFIELD_TYPE__OPTIONS = POS_VIZ_DATA_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int ECLFIELD_TYPE_FEATURE_COUNT = POS_VIZ_DATA_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link org.xtext.hipie.hIPIE.impl.out_datasetImpl <em>out dataset</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.xtext.hipie.hIPIE.impl.out_datasetImpl
   * @see org.xtext.hipie.hIPIE.impl.HIPIEPackageImpl#getout_dataset()
   * @generated
   */
  int OUT_DATASET = 39;
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.hipie.hIPIE.base_prop#getVals <em>Vals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.value_list#getVals <em>Vals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vals</em>'.
   * @see org.xtext.hipie.hIPIE.value_list#getVals()
   * @see #getvalue_list()
   * @generated
   */
  EReference getvalue_list_Vals();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.assign#getVals <em>Vals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vals</em>'.
  ...
  /**
   * Returns the meta object for class '{@link org.xtext.hipie.hIPIE.pos_viz_data <em>pos viz data</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>pos viz data</em>'.
   * @see org.xtext.hipie.hIPIE.pos_viz_data
   * @generated
   */
  EClass getpos_viz_data();

  /**
   * Returns the meta object for the attribute '{@link org.xtext.hipie.hIPIE.pos_viz_data#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.xtext.hipie.hIPIE.pos_viz_data#getName()
   * @see #getpos_viz_data()
   * @generated
   */
  EAttribute getpos_viz_data_Name();
  ...
  /**
   * Returns the meta object for the reference list '{@link org.xtext.hipie.hIPIE.OutputOption#getVars <em>Vars</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Vars</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.OutputOption#getVals <em>Vals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vals</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.OutputOption#getOutput_internal <em>Output internal</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Output internal</em>'.
   * @see org.xtext.hipie.hIPIE.OutputOption#getOutput_internal()
   * @see #getOutputOption()
   * @generated
   */
  EReference getOutputOption_Output_internal();
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.hipie.hIPIE.out_type#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Ops</em>'.
   * @see org.xtext.hipie.hIPIE.out_type#getOps()
   * @see #getout_type()
   * @generated
   */
  EReference getout_type_Ops();

  /**
   * Returns the meta object for class '{@link org.xtext.hipie.hIPIE.out_dataset <em>out dataset</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>out dataset</em>'.
   * @see org.xtext.hipie.hIPIE.out_dataset
   * @generated
   */
  EClass getout_dataset();

  /**
   * Returns the meta object for the attribute '{@link org.xtext.hipie.hIPIE.out_dataset#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.xtext.hipie.hIPIE.out_dataset#getName()
   * @see #getout_dataset()
   * @generated
   */
  EAttribute getout_dataset_Name();

  /**
   * Returns the meta object for the containment reference '{@link org.xtext.hipie.hIPIE.out_dataset#getOut_base <em>Out base</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Out base</em>'.
   * @see org.xtext.hipie.hIPIE.out_dataset#getOut_base()
   * @see #getout_dataset()
   * @generated
   */
  EReference getout_dataset_Out_base();

  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.out_dataset#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Ops</em>'.
   * @see org.xtext.hipie.hIPIE.out_dataset#getOps()
   * @see #getout_dataset()
   * @generated
   */
  EReference getout_dataset_Ops();

  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.out_dataset#getEcl_vars <em>Ecl vars</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Ecl vars</em>'.
   * @see org.xtext.hipie.hIPIE.out_dataset#getEcl_vars()
   * @see #getout_dataset()
   * @generated
   */
  EReference getout_dataset_Ecl_vars();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.VisualSection#getVis_ops <em>Vis ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link org.xtext.hipie.hIPIE.VisBasis#getAssigned <em>Assigned</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Assigned</em>'.
   * @see org.xtext.hipie.hIPIE.VisBasis#getAssigned()
   * @see #getVisBasis()
   * @generated
   */
  EReference getVisBasis_Assigned();

  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.VisBasis#getQuals <em>Quals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.vis_basis_qualifiers#getFuncs <em>Funcs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Funcs</em>'.
   * @see org.xtext.hipie.hIPIE.vis_basis_qualifiers#getFuncs()
   * @see #getvis_basis_qualifiers()
   * @generated
   */
  EReference getvis_basis_qualifiers_Funcs();
  ...
  /**
   * Returns the meta object for the reference list '{@link org.xtext.hipie.hIPIE.function#getVars <em>Vars</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Vars</em>'.
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.hipie.hIPIE.function#getVals <em>Vals</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vals</em>'.
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference VALUE_LIST__VALS = eINSTANCE.getvalue_list_Vals();
    ...
    /**
     * The meta object literal for the '{@link org.xtext.hipie.hIPIE.impl.pos_viz_dataImpl <em>pos viz data</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.xtext.hipie.hIPIE.impl.pos_viz_dataImpl
     * @see org.xtext.hipie.hIPIE.impl.HIPIEPackageImpl#getpos_viz_data()
     * @generated
     */
    EClass POS_VIZ_DATA = eINSTANCE.getpos_viz_data();
     ...
     * @generated
     */
    EAttribute POS_VIZ_DATA__NAME = eINSTANCE.getpos_viz_data_Name();
     ...
     * @generated
     */
    EReference OUTPUT_OPTION__OUTPUT_INTERNAL = eINSTANCE.getOutputOption_Output_internal();
     ...
     * @generated
     */
    EReference OUT_TYPE__OPS = eINSTANCE.getout_type_Ops();

    /**
     * The meta object literal for the '{@link org.xtext.hipie.hIPIE.impl.out_datasetImpl <em>out dataset</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.xtext.hipie.hIPIE.impl.out_datasetImpl
     * @see org.xtext.hipie.hIPIE.impl.HIPIEPackageImpl#getout_dataset()
     * @generated
     */
    EClass OUT_DATASET = eINSTANCE.getout_dataset();
     ...
     * @generated
     */
    EAttribute OUT_DATASET__NAME = eINSTANCE.getout_dataset_Name();
     ...
     * @generated
     */
    EReference OUT_DATASET__OUT_BASE = eINSTANCE.getout_dataset_Out_base();
     ...
     * @generated
     */
    EReference OUT_DATASET__OPS = eINSTANCE.getout_dataset_Ops();
     ...
     * @generated
     */
    EReference OUT_DATASET__ECL_VARS = eINSTANCE.getout_dataset_Ecl_vars();
     ...
     * @generated
     */
    EReference VIS_BASIS__ASSIGNED = eINSTANCE.getVisBasis_Assigned();
     ...
     * @generated
     */
    EReference VIS_BASIS_QUALIFIERS__FUNCS = eINSTANCE.getvis_basis_qualifiers_Funcs();
