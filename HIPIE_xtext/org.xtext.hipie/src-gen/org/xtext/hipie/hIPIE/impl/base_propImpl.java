...
public class base_propImpl extends MinimalEObjectImpl.Container implements base_prop
{
   ...
   * @generated
   */
  public NotificationChain basicSetVals(value_list newVals, NotificationChain msgs)
  {
    value_list oldVals = vals;
    vals = newVals;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HIPIEPackage.BASE_PROP__VALS, oldVals, newVals);
   ...
   * @generated
   */
  public void setVals(value_list newVals)
  {
    if (newVals != vals)
    {
      NotificationChain msgs = null;
      if (vals != null)
        msgs = ((InternalEObject)vals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HIPIEPackage.BASE_PROP__VALS, null, msgs);
      if (newVals != null)
        msgs = ((InternalEObject)newVals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HIPIEPackage.BASE_PROP__VALS, null, msgs);
      msgs = basicSetVals(newVals, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HIPIEPackage.BASE_PROP__VALS, newVals, newVals));
  }
