...
public class OutputSectionImpl extends MinimalEObjectImpl.Container implements OutputSection
{
   ...
   * @ordered
   */
  protected EList<output_value> outputs;
   ...
   * @generated
   */
  public EList<output_value> getOutputs()
  {
    if (outputs == null)
    {
      outputs = new EObjectContainmentEList<output_value>(output_value.class, this, HIPIEPackage.OUTPUT_SECTION__OUTPUTS);
    }
    return outputs;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case HIPIEPackage.OUTPUT_SECTION__OUTPUTS:
        getOutputs().clear();
        getOutputs().addAll((Collection<? extends output_value>)newValue);
        return;
    }
