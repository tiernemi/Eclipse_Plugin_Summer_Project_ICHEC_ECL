...
public class HIPIEPackageImpl extends EPackageImpl implements HIPIEPackage
{
   ...
   * @generated
   */
  private EClass pos_viz_dataEClass = null;
   ...
   * @generated
   */
  private EClass out_datasetEClass = null;
   ...
   * @generated
   */
  public EReference getvalue_list_Vals()
  {
    return (EReference)value_listEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getpos_viz_data()
  {
    return pos_viz_dataEClass;
  }
   ...
   * @generated
   */
  public EAttribute getpos_viz_data_Name()
  {
    return (EAttribute)pos_viz_dataEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getOutputOption_Output_internal()
  {
   ...
   * @generated
   */
  public EReference getout_type_Ops()
  {
    return (EReference)out_typeEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getout_dataset()
  {
    return out_datasetEClass;
  }
   ...
   * @generated
   */
  public EAttribute getout_dataset_Name()
  {
    return (EAttribute)out_datasetEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getout_dataset_Out_base()
  {
    return (EReference)out_datasetEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getout_dataset_Ops()
  {
    return (EReference)out_datasetEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getout_dataset_Ecl_vars()
  {
    return (EReference)out_datasetEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getVisBasis_Assigned()
  {
   ...
   * @generated
   */
  public EReference getvis_basis_qualifiers_Funcs()
  {
    return (EReference)vis_basis_qualifiersEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(value_listEClass, VALUE_LIST__VALS);
    ...
    pos_viz_dataEClass = createEClass(POS_VIZ_DATA);
    createEAttribute(pos_viz_dataEClass, POS_VIZ_DATA__NAME);
    ...
    createEReference(outputOptionEClass, OUTPUT_OPTION__OUTPUT_INTERNAL);

    outputOptionsEClass = createEClass(OUTPUT_OPTIONS);

    out_typeEClass = createEClass(OUT_TYPE);
    createEReference(out_typeEClass, OUT_TYPE__OPS);

    out_datasetEClass = createEClass(OUT_DATASET);
    createEAttribute(out_datasetEClass, OUT_DATASET__NAME);
    createEReference(out_datasetEClass, OUT_DATASET__OUT_BASE);
    createEReference(out_datasetEClass, OUT_DATASET__OPS);
    createEReference(out_datasetEClass, OUT_DATASET__ECL_VARS);
    ...
    createEReference(visBasisEClass, VIS_BASIS__ASSIGNED);
    createEReference(visBasisEClass, VIS_BASIS__QUALS);

    vis_basis_qualifiersEClass = createEClass(VIS_BASIS_QUALIFIERS);
    createEReference(vis_basis_qualifiersEClass, VIS_BASIS_QUALIFIERS__FUNCS);
  ...
  public void initializePackageContents()
  {
    ...
    field_declEClass.getESuperTypes().add(this.getpos_viz_data());
    ...
    eclfield_typeEClass.getESuperTypes().add(this.getpos_viz_data());
    eclfield_typeEClass.getESuperTypes().add(this.getecloutput_decl());
    outputOptionEClass.getESuperTypes().add(this.getOutputOptions());
    out_typeEClass.getESuperTypes().add(this.getoutput_value());
    out_datasetEClass.getESuperTypes().add(this.getoutput_value());
    ...
    initEReference(getvalue_list_Vals(), this.getvalue(), null, "vals", null, 0, -1, value_list.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getassign_Vals(), this.getvalue_list(), null, "vals", null, 0, -1, assign.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getInputSection_Inputs(), this.getinput_value(), null, "inputs", null, 0, -1, InputSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOutputSection_Outputs(), this.getoutput_value(), null, "outputs", null, 0, -1, OutputSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(geteclfield_type_Options(), this.getOutputOptions(), null, "options", null, 0, -1, eclfield_type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(pos_viz_dataEClass, pos_viz_data.class, "pos_viz_data", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getpos_viz_data_Name(), ecorePackage.getEString(), "name", null, 0, 1, pos_viz_data.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOutputOption_Output_internal(), this.getOutputOption(), null, "output_internal", null, 0, -1, OutputOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getout_type_Ops(), this.getOutputOptions(), null, "ops", null, 0, 1, out_type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(out_datasetEClass, out_dataset.class, "out_dataset", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getout_dataset_Name(), ecorePackage.getEString(), "name", null, 0, 1, out_dataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getout_dataset_Out_base(), this.getoutputbase(), null, "out_base", null, 0, 1, out_dataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getout_dataset_Ops(), this.getOutputOptions(), null, "ops", null, 0, -1, out_dataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getout_dataset_Ecl_vars(), this.getecloutput_decl(), null, "ecl_vars", null, 0, -1, out_dataset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVisualSection_Vis_ops(), this.getvisual_section_options(), null, "vis_ops", null, 0, -1, VisualSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getvisualization_Inputs(), this.getVisBasis(), null, "inputs", null, 0, -1, visualization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVisBasis_Assigned(), this.getout_dataset(), null, "assigned", null, 0, 1, VisBasis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getVisBasis_Quals(), this.getvis_basis_qualifiers(), null, "quals", null, 0, -1, VisBasis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getvis_basis_qualifiers_Funcs(), this.getfunction(), null, "funcs", null, 0, -1, vis_basis_qualifiers.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(functionEClass, function.class, "function", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getfunction_Vars(), this.getpos_viz_data(), null, "vars", null, 0, -1, function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
