...
public class visualizationImpl extends MinimalEObjectImpl.Container implements visualization
{
   ...
   * @ordered
   */
  protected EList<VisBasis> inputs;
   ...
   * @generated
   */
  public EList<VisBasis> getInputs()
  {
    if (inputs == null)
    {
      inputs = new EObjectContainmentEList<VisBasis>(VisBasis.class, this, HIPIEPackage.VISUALIZATION__INPUTS);
    }
    return inputs;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case HIPIEPackage.VISUALIZATION__INPUTS:
        getInputs().clear();
        getInputs().addAll((Collection<? extends VisBasis>)newValue);
        return;
      case HIPIEPackage.VISUALIZATION__VIS_OPS:
        getVis_ops().clear();
