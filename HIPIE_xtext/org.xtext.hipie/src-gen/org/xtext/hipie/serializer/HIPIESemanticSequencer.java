...
public class HIPIESemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == HIPIEPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case HIPIEPackage.OUTPUT_OPTION:
				...
				else if(context == grammarAccess.getOutputOptionsRule()) {
					sequence_OutputOption_OutputOptions(context, (OutputOption) semanticObject); 
					return; 
				}
				else break;
			...
			case HIPIEPackage.ASSIGN:
				...
				else if(context == grammarAccess.getAssign_listRule()) {
					sequence_assign_assign_list(context, (assign) semanticObject); 
					return; 
				}
				else break;
			...
			case HIPIEPackage.ECL_DATA:
				if(context == grammarAccess.getEcl_dataRule() ||
				   ...
				   context == grammarAccess.getPos_viz_dataRule()) {
			...
			case HIPIEPackage.OUT_DATASET:
				if(context == grammarAccess.getOut_datasetRule()) {
					sequence_out_dataset(context, (out_dataset) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getOutput_valueRule()) {
					sequence_out_dataset_output_value(context, (out_dataset) semanticObject); 
					return; 
				}
				else break;
			...
			case HIPIEPackage.VALUE:
				if(context == grammarAccess.getOutput_valueRule()) {
			...
			case HIPIEPackage.VALUE_LIST:
				sequence_value_list(context, (value_list) semanticObject); 
				return; 
			case HIPIEPackage.VIS_BASIS_QUALIFIERS:
				sequence_vis_basis_qualifiers(context, (vis_basis_qualifiers) semanticObject); 
				return; 
	 ...
	 *     )
	 */
	protected void sequence_OutputOption_OutputOptions(EObject context, OutputOption semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (assigned=[out_dataset|ID] quals+=vis_basis_qualifiers?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID vals+=value_list assign_internal+=assign*)
	 */
	protected void sequence_assign_assign_list(EObject context, assign semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_out_dataset(EObject context, out_dataset semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=ID out_base=outputbase? ops+=OutputOptions? ecl_vars+=ecloutput_decl*)
	 */
	protected void sequence_out_dataset_output_value(EObject context, out_dataset semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     ((name=ID | int_val=INT | str_val=STRING) ops=OutputOptions?)
	 */
	...
	/**
	 * Constraint:
	 *     ((name=ID | int_val=INT | str_val=STRING) res_ops+=resource_options?)
	 */
	 ...
	 */
	protected void sequence_value_list(EObject context, value_list semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_vis_basis_qualifiers(EObject context, vis_basis_qualifiers semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     ((name=ID inputs+=VisBasis vis_ops+=visual_options?) | (name=ID vis_ops+=visual_options?))
	 */
