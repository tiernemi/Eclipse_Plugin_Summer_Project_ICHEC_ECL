 ...
 * <ul>
 *   <li>{@link org.xtext.hipie.hIPIE.visual_section#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.visual_section#getVis_ops <em>Vis ops</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.visual_section#getVis_elements <em>Vis elements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisual_section()
 * @model
 * @generated
 */
public interface visual_section extends EObject
{
  /**
   ...
   * @see #setName(String)
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisual_section_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.hipie.hIPIE.visual_section#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisual_section_Vis_ops()
   ...
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisual_section_Vis_elements()
   * @model containment="true"
   * @generated
   */
