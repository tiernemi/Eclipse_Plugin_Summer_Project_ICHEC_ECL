 ...
 * <ul>
 *   <li>{@link org.xtext.hipie.hIPIE.impl.output_optionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.impl.output_optionImpl#getVars <em>Vars</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.impl.output_optionImpl#getVals <em>Vals</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.impl.output_optionImpl#getOutput_internal <em>Output internal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class output_optionImpl extends output_optionsImpl implements output_option
{
  /**
   ...
   * @ordered
   */
  protected EList<output_option> output_internal;
   ...
   * @generated
   */
  public EList<output_option> getOutput_internal()
  {
    if (output_internal == null)
    {
      output_internal = new EObjectContainmentEList<output_option>(output_option.class, this, HIPIEPackage.OUTPUT_OPTION__OUTPUT_INTERNAL);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case HIPIEPackage.OUTPUT_OPTION__OUTPUT_INTERNAL:
        ...
        getOutput_internal().addAll((Collection<? extends output_option>)newValue);
        return;
    }
