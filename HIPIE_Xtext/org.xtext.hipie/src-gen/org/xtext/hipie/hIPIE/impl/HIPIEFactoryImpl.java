...
public class HIPIEFactoryImpl extends EFactoryImpl implements HIPIEFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case HIPIEPackage.INPUT_SECTION: return createinput_section();
      ...
      case HIPIEPackage.OUTPUT_SECTION: return createoutput_section();
      ...
      case HIPIEPackage.OUTPUT_OPTION: return createoutput_option();
      case HIPIEPackage.OUTPUT_OPTIONS: return createoutput_options();
   ...
   * @generated
   */
  public input_section createinput_section()
  {
    input_sectionImpl input_section = new input_sectionImpl();
   ...
   * @generated
   */
  public output_section createoutput_section()
  {
    output_sectionImpl output_section = new output_sectionImpl();
   ...
   * @generated
   */
  public output_option createoutput_option()
  {
    output_optionImpl output_option = new output_optionImpl();
   ...
   * @generated
   */
  public output_options createoutput_options()
  {
    output_optionsImpl output_options = new output_optionsImpl();
   ...
   * @generated
   */
  public visual_section createvisual_section()
  {
    visual_sectionImpl visual_section = new visual_sectionImpl();
   ...
   * @generated
   */
  public vis_basis createvis_basis()
  {
    vis_basisImpl vis_basis = new vis_basisImpl();
    return vis_basis;
  }
