 ...
 *   <li>{@link org.xtext.hipie.hIPIE.visualization#getInputs <em>Inputs</em>}</li>
 *   <li>{@link org.xtext.hipie.hIPIE.visualization#getVis_ops <em>Vis ops</em>}</li>
 * </ul>
 * </p>
 *
...
public interface visualization extends EObject
{
   ...
   * The list contents are of type {@link org.xtext.hipie.hIPIE.vis_basis}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisualization_Inputs()
   * @model containment="true"
   * @generated
   */
  EList<vis_basis> getInputs();

  /**
   * Returns the value of the '<em><b>Vis ops</b></em>' containment reference list.
   * The list contents are of type {@link org.xtext.hipie.hIPIE.visual_options}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getvisualization_Vis_ops()
   * @model containment="true"
   * @generated
   */
  EList<visual_options> getVis_ops();
