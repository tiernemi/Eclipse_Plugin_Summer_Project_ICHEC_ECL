 ...
 * <ul>
 *   <li>{@link org.xtext.hipie.hIPIE.OutputOption#getType <em>Type</em>}</li>
...
public interface OutputOption extends EObject
{
   ...
   * @see #setType(String)
   * @see org.xtext.hipie.hIPIE.HIPIEPackage#getOutputOption_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link org.xtext.hipie.hIPIE.OutputOption#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
