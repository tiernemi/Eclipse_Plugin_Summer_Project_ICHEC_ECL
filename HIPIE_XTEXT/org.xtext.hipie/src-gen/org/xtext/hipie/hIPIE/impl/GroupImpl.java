...
public class GroupImpl extends InputValueImpl implements Group
{
   ...
   * @ordered
   */
  protected EList<InputValue> vals;
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HIPIEPackage.GROUP__NAME, oldName, name));
  }
  ...
  public EList<InputValue> getVals()
  {
    if (vals == null)
    {
      vals = new EObjectContainmentEList<InputValue>(InputValue.class, this, HIPIEPackage.GROUP__VALS);
    }
    return vals;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case HIPIEPackage.GROUP__VALS:
        getVals().clear();
        getVals().addAll((Collection<? extends InputValue>)newValue);
        return;
    }
