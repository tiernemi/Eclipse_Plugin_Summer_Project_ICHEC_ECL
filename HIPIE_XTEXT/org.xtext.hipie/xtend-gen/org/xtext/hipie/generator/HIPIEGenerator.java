...
public class HIPIEGenerator implements IGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess fsa) {
    try {
      ...
      IPath project_path = _parent_1.getFullPath();
      IWorkspace _workspace_2 = ResourcesPlugin.getWorkspace();
      IWorkspaceRoot _root_2 = _workspace_2.getRoot();
      IFolder project_folder = _root_2.getFolder(project_path);
      IFolder data_folder = project_folder.getFolder("data");
      IWorkspace _workspace_3 = ResourcesPlugin.getWorkspace();
      IWorkspaceRoot _root_3 = _workspace_3.getRoot();
      IPath _fullPath_1 = data_folder.getFullPath();
      IContainer data_folder_container = _root_3.getContainerForLocation(_fullPath_1);
      final IResource[] cont_files = data_folder_container.members();
      IPath _rawLocation = data_folder_container.getRawLocation();
      final String data_folder_path = _rawLocation.toString();
      ...
      for (final Integer i : _doubleDotLessThan) {
        ...
        IPath _rawLocation_1 = _get.getRawLocation();
        String _string = _rawLocation_1.toString();
      ...
      streamString = _string_1;
      String _string_2 = new String();
      streamString_er = _string_2;
      ...
      java.nio.file.Path _path_3 = _default_1.getPath(output_filepath);
      Files.delete(_path_3);
