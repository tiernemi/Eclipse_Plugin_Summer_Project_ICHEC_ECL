...
public class EmptyEditorPropertyTester extends PropertyTester {

	public static final String PROPERTY_NAMESPACE = "name.editor.empty";
	public static final String PROPERTY_IS_EDITOR_NOT_EMPTY= "IsECLEditorNotEmpty";
	
	public EmptyEditorPropertyTester() {
	...
	public boolean test(Object receiver, String property, Object[] args,
		...
		if (PROPERTY_IS_EDITOR_NOT_EMPTY.equals(property)) 
		{
